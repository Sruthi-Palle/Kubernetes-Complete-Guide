...
> 💡 This article covers upgrading a Kubernetes cluster. Here, we will explain the upgrading a Kubernetes cluster focusing on the core control plane components, while keeping external dependencies like ETCD and CoreDNS aside. In a previous article, we discussed how Kubernetes manages software releases and how its components can have independent versioning.
...
- The controller manager and scheduler can run on version v1.10 or v1.9.
- The Kubelet and Kube Proxy can run on version v1.8 or v1.9 or v1.10.
...
![alt text](../Images/Cluster-Upgrade-2.png)
...
3. Add new nodes with the updated software version, migrate workloads to these new nodes, and then decommission the older nodes.
   ![alt text](../Images/Cluster-Upgrade-5.png)
...
![alt text](../Images/Cluster-Upgrade-6.png)
...
![alt text](../Images/Cluster-Upgrade-7.png)
...
![alt text](../Images/Cluster-Upgrade-8.png)
...
![alt text](../Images/Cluster-Upgrade-9.png)

- Upgrade all worker nodes in the same way

![alt text](../Images/Cluster-Upgrade-10.png)
