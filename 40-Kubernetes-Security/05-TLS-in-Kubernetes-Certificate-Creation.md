...
> While there are other popular tools such as EasyRSA and CFSSL, we will focus on using OpenSSL to create both Certificate Authority (CA) and client/server certificates. This approach secures the communications within your Kubernetes cluster and ensures certified access.
...
2. Create Certificate Signing Request[CSR] (ca.csr)
...
![alt text](../Images/TLS-in-Kubernetes-Certificate-Creation.png)
...
![alt text](../Images/TLS-in-Kubernetes-Certificate-Creation-1.png)
...
![alt text](../Images/TLS-in-Kubernetes-Certificate-Creation-2.png)
...
![alt text](../Images/TLS-in-Kubernetes-Certificate-Creation-3.png)
