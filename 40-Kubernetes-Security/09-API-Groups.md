...
Before diving into authorization, it's essential to understand the concept of API groups in Kubernetes and how they integrate with overall cluster operations.
...
1. **Core API Group:**\
   ...
   ![alt text](../Images/API-Groups-1.png)
...
![alt text](../Images/API-Groups-2.png)
...
![alt text](../Images/API-Groups-3.png)
