...
![alt text](../Images/PriorityClasses.png)
...
![alt text](../Images/PriorityClasses-1.png)
...
> 💡For more details on Kubernetes scheduling and priority, refer to the [scheduling eviction](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/).
